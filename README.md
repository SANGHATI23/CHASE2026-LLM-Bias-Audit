...
![Models](https://img.shields.io/badge/Models-Llama%203%2070B%20%7C%20GPT--4o-orange)
![Vignettes](https://img.shields.io/badge/Pilot-50%20Vignettes%20%C3%97%202%20Models%20%C3%97%203%20Runs-red)

</div>

---

> **"Can Generative AI Mitigate or Amplify Screening Disparities? A Fairness Audit and Gap-Detection Framework for Social Determinants of Health Screening"**
>
> Submitted to the **IEEE/ACM CHASE 2026 Workshop on Generative AI for Smart Health and Biomedical Informatics**
> Track #11 — Generative AI for Health Disparities and Equity
...
4. [Demographic Conditions](#4-demographic-conditions)
5. [Classification Method](#5-classification-method)
6. [Fairness Metrics](#6-fairness-metrics)
7. [Real-World Benchmarks](#7-real-world-benchmarks-namcs)
8. [Key Results — Llama 3 70B](#8-key-results--llama-3-70b-pilot-audit)
9. [Key Results — GPT-4o](#9-key-results--gpt-4o-pilot-audit)
10. [Cross-Model Comparison](#10-cross-model-comparison)
11. [GPT-4o Follow-Up Quality Audit](#11-gpt-4o-follow-up-quality-audit)
12. [Part 2 — Gap-Detection Model](#12-part-2--gap-detection-model-in-progress)
13. [Governance Implications](#13-governance-implications)
14. [Repository Structure](#14-repository-structure)
15. [Scripts Reference](#15-scripts-reference)
16. [Results Files Reference](#16-results-files-reference)
17. [Figures Reference](#17-figures-reference)
18. [Full Pilot Results Tables](#18-full-pilot-results-tables)
19. [Reproducing the Experiment](#19-reproducing-the-experiment)
20. [Camera-Ready Roadmap](#20-camera-ready-roadmap)
21. [Discussion of Limitations](#21-discussion-of-limitations)
22. [Citation](#22-citation)
23. [Requirements](#23-requirements)
24. [Ethics Statement](#24-ethics-statement)
